...
configs = [
    ...
    # VelocityConfig(50, 0.04, 0.6),
    # VelocityConfig(50, 0.06, 0.6),
    VelocityConfig(50, 0.08, 0.6),
    VelocityConfig(50, 0.10, 0.6),
    VelocityConfig(50, 0.12, 0.6),
    VelocityConfig(50, 0.14, 0.6),
    # VelocityConfig(50, 0.10, 0.6),
...
def main():
    ...
    try:
        ...
        if first is None:
            print("Romi not found. Exiting...")
            return 1

        com_port = first.device if hasattr(first, "device") else first.name
        print(f"Found device on {com_port}. Opening serial...", end="")
        ...
        for config in configs:
            ...
            filename = f'P{kp:.2f}_I{ki:.2f}.csv'
